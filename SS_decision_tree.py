...
class Question:
    ...
    def __repr__(self):
        ...
        header = ["blocknum", "narrow_base", "on_lean", "block_displaced", "stability"]
        condition = "=="
...
def decision_tree(train_data):
    ...
    train_predictions = [] # format of predictions: [stability, numblocks, narrow, lean, displaced, classifier] (1=stable, 1=narrow, 1=lean, 1=displaced, 1=logic)
    for i in range(len(train_data)):
        ...
        for i in range(1,len(row)-1): features.append(row[i]) # create a list containing the stability prediction and the features of the structure
